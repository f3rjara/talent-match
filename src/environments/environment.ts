export const environment = {
  production: false,
  BASE_URL: 'http://flow-m-Publi-MjNq3yo7kk3C-127344816.us-west-2.elb.amazonaws.com',
  AUTH_API_URL: 'http://flow-m-Publi-MjNq3yo7kk3C-127344816.us-west-2.elb.amazonaws.com/api/auth',
  AUTH_API_LOGIN_URL: 'http://flow-m-Publi-MjNq3yo7kk3C-127344816.us-west-2.elb.amazonaws.com/api/auth/login',
